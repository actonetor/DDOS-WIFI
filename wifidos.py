# Disclaimer: This script is for educational purposes only.  Do not use against any network that you don't own or have authoriza>
...
# If so we re# statement to add it to the lst.
...
print("DDOS WIFI PAR MAC ADRESSE AIRMON-NG") 
print("")
print("")
print("")
...
print("")
print("")
print("                                                                                       __        _____________  _______          ")
print("|          |            /\               |       /        O     |\          |         /                |       /       \         ")
print("|          |           /  \              |      /               | \         |        /                 |      /         \        ")
print("|          |          /    \             |     /          |     |  \        |       /                  |     /           \       ")
print("|          |         /      \            |    /           |     |   \       |       |                  |    |             |      ")
...
try:
    while True:
        ...
        print("Scanning.Apuyer sur Ctrl+C pour selectionner votre réseau\n")
